...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--config', help='test config file path',default='/home/lenovo/Downloads/mmsegmentation/work_dirs/lraspp_m-v3s-d8_512x1024_320k_rugd/lraspp_m-v3s-d8_512x1024_320k_rugd.py')
    parser.add_argument('--model', help='Input model file',default='/home/lenovo/rknn-toolkit2-master/examples/onnx/yolov5/tmp.onnx')
    parser.add_argument(
        '--backend',
        help='Backend of the model.',
        choices=['onnxruntime', 'tensorrt'],default='onnxruntime')
    ...
    parser.add_argument(
        ...
        ' for generic datasets, and "cityscapes" for Cityscapes',default='mIoU')
