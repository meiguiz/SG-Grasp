...
def parse_args():
    ...
    parser.add_argument('--config', help='test config file path', default='/media/meiguiz/HIKVISION/mmsegmentation/work_dirs/ALL/segformer_mit-b3_8x1_1024x1024_160k_cityscapes.py')
    parser.add_argument('--checkpoint', help='checkpoint file', default='/media/meiguiz/HIKVISION/mmsegmentation/work_dirs/ALL/iter_120000.pth')
    parser.add_argument(
...
if __name__ == '__main__':
    ...
    if args.checkpoint:
        checkpoint = load_checkpoint(
            segmentor, args.checkpoint, map_location='cuda')
